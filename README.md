...
**Optional** - If you use the `eloquent` driver, create the database table in your application
...
Create a migration in your application for the `api_clients` table (or your custom table name).
